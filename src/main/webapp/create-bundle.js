...
const electrisimScripts = [
    ...
    'js/electrisim/windTurbineDialog.js',
    ...
    'js/electrisim/dialogs/RegControlDialog.js',
    'js/electrisim/dialogs/CapControlDialog.js',
    'js/electrisim/dialogs/StorageControllerDialog.js',
    'js/electrisim/dialogs/WindTurbineControllerDialog.js',
    'js/electrisim/dialogs/WindTurbineDynamicControllerDialog.js',
    'js/electrisim/dialogs/ParkControllerDialog.js',
