...
// Default values for Line DC parameters (based on pandapower documentation)
export const defaultLineDcData = {
    name: "Line DC",
    from_bus: "",
    to_bus: "",
    length_km: 0.0,
...
export class LineDcDialog extends Dialog {
    constructor(editorUi) {
        super('Line DC Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'loadflow';
        this.data = { ...defaultLineDcData };
        this.inputs = new Map();
        ...
        this.loadFlowParameters = [
            ...
            },
            {
                ...
                label: 'From Bus',
                symbol: 'from_bus',
                description: 'Index of the sending-end DC bus',
                type: 'text',
                value: this.data.from_bus
            },
            {
                id: 'to_bus',
                label: 'To Bus',
                symbol: 'to_bus',
                description: 'Index of the receiving-end DC bus',
                type: 'text',
                value: this.data.to_bus
            },
            {
                id: 'length_km',
                label: 'Length',
                symbol: 'length_km',
                unit: 'km',
                description: 'Length of the DC line in kilometers',
                type: 'number',
            ...
            },
            {
                ...
                symbol: 'r_ohm_per_km',
                unit: 'Ω/km',
                description: 'Resistance per kilometer of the DC line',
                type: 'number',
            ...
            },
            {
                ...
                symbol: 'max_i_ka',
                unit: 'kA',
                description: 'Maximum current rating of the DC line',
                type: 'number',
    ...
    getDescription() {
        return '<strong>Configure Line DC Parameters</strong><br>Set parameters for DC transmission line. See the <a href="https://electrisim.com/documentation.html#dc-line" target="_blank" rel="noopener noreferrer">Electrisim documentation</a>.';
    }
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('Line DC values:', values);
...
if (typeof window !== 'undefined') {
    window.LineDcDialog = LineDcDialog;
    window.defaultLineDcData = defaultLineDcData;
}
