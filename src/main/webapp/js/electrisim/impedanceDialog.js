...
export class ImpedanceDialog extends Dialog {
    constructor(editorUi) {
        super('Impedance Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'electrical';
        this.data = { ...defaultImpedanceData };
        ...
        this.electricalParameters = [
            {
                id: 'name',
                label: 'Impedance Name',
                description: 'Name identifier for the impedance element',
                type: 'text',
            ...
            },
            {
                id: 'r_pu',
                label: 'Real Part (p.u.)',
                description: 'Real part of the impedance in per unit',
                type: 'number',
                value: this.data.r_pu.toString(),
                step: '0.01'
            },
            {
                id: 'x_pu',
                label: 'Imaginary Part (p.u.)',
                description: 'Imaginary part of the impedance in per unit',
                type: 'number',
                value: this.data.x_pu.toString(),
                step: '0.01'
            }
        ];
        ...
        this.ratingParameters = [
            {
                ...
                description: 'Rated power of the impedance in MVA',
                type: 'number',
            ...
            },
            {
                id: 'in_service',
                label: 'In Service',
                description: 'Specifies if the impedance element is in service (True/False)',
                type: 'checkbox',
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('Impedance values:', values);
    ...
    destroy() {
        ...
        console.log('Impedance dialog destroyed and flags cleared');
    }
    
    populateDialog(cellData) {
        console.log('=== ImpedanceDialog.populateDialog called ===');
        ...
        console.log('=== ImpedanceDialog.populateDialog completed ===');
    }
}

// Note: Legacy AG-Grid exports have been removed to prevent conflicts with the new modern dialog system
// The ImpedanceDialog class is now the primary interface for editing impedance parameters
