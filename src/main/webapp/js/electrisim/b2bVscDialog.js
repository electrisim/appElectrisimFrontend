...
export const defaultB2bVscData = {
    name: "B2B VSC",
    bus1: "",
    bus2: "",
    p_mw: 0.0,
...
export class B2bVscDialog extends Dialog {
    constructor(editorUi) {
        super('B2B VSC Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'loadflow';
        this.data = { ...defaultB2bVscData };
        this.inputs = new Map();
        ...
        this.loadFlowParameters = [
            {
                ...
                label: 'Name',
                symbol: 'name',
                description: 'Name identifier for the B2B VSC',
                type: 'text',
            ...
            },
            {
                ...
                label: 'Bus 1',
                symbol: 'bus1',
                description: 'Index of the first AC bus',
                type: 'text',
                value: this.data.bus1
            },
            {
                id: 'bus2',
                label: 'Bus 2',
                symbol: 'bus2',
                description: 'Index of the second AC bus',
                type: 'text',
                value: this.data.bus2
            },
            {
                id: 'p_mw',
                label: 'Active Power',
                symbol: 'p_mw',
                unit: 'MW',
                description: 'Active power at bus 1',
                type: 'number',
            ...
            {
                id: 'vm1_pu',
                label: 'Voltage Magnitude Bus 1',
                symbol: 'vm1_pu',
                unit: 'p.u.',
                description: 'Voltage magnitude setpoint at bus 1 in p.u.',
                type: 'number',
                value: this.data.vm1_pu.toString(),
                step: '0.01',
                min: '0'
            },
            {
                ...
                symbol: 'vm2_pu',
                unit: 'p.u.',
                description: 'Voltage magnitude setpoint at bus 2 in p.u.',
                type: 'number',
                value: this.data.vm2_pu.toString(),
                step: '0.01',
                min: '0'
            },
            {
                ...
                symbol: 'sn_mva',
                unit: 'MVA',
                description: 'Rated apparent power of the B2B VSC',
                type: 'number',
            ...
            },
            {
                ...
                label: 'In Service',
                symbol: 'in_service',
                description: 'Specifies if the B2B VSC is in service (True/False)',
                type: 'checkbox',
    ...
    getDescription() {
        return '<strong>Configure B2B VSC Parameters</strong><br>Set parameters for Back-to-Back Voltage Source Converter connecting asynchronous grids. See the <a href="https://pandapower.readthedocs.io/en/latest/elements/b2b_vsc.html" target="_blank">Pandapower documentation</a>.';
    }
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('B2B VSC values:', values);
...
if (typeof window !== 'undefined') {
    window.B2bVscDialog = B2bVscDialog;
    window.defaultB2bVscData = defaultB2bVscData;
}
