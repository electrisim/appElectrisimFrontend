...
// Default values for SVC parameters (based on pandapower documentation)
export const defaultSVCData = {
    name: "SVC",
    x_l_ohm: 0.0,
    x_cvar_ohm: 0.0,
    set_vm_pu: 0.0,
...
export class SVCDialog extends Dialog {
    constructor(editorUi) {
        super('SVC Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'electrical';
        this.data = { ...defaultSVCData };
        ...
        this.electricalParameters = [
            {
                id: 'name',
                label: 'SVC Name',
                description: 'Name identifier for the SVC',
                type: 'text',
            ...
            },
            {
                ...
                description: 'Inductive reactance of the reactor component of SVC',
                type: 'number',
            ...
            },
            {
                ...
                description: 'Capacitive reactance of the fixed capacitor component of SVC (must be ≤ 0)',
                type: 'number',
        ...
        this.controlParameters = [
            ...
            },
            {
                ...
                description: 'The value of thyristor firing angle of SVC (is used directly if controllable==False)',
                type: 'number',
        ...
        this.configParameters = [
            ...
            },
            {
                id: 'in_service',
                label: 'In Service',
                description: 'Specifies if the SVC is in service (True/False)',
                type: 'checkbox',
    ...
    destroy() {
        ...
        console.log('SVC dialog destroyed and flags cleared');
    }
    
    populateDialog(cellData) {
        console.log('=== SVCDialog.populateDialog called ===');
...
export const columnDefsSVC = [  
    ...
    {
        field: "x_cvar_ohm",
        headerTooltip: "Capacitive reactance of the fixed capacitor component of SVC (must be ≤ 0)",
        maxWidth: 140,
    ...
    },
    {
        ...
        headerTooltip: "The value of thyristor firing angle of SVC (is used directly if controllable==False)",
        maxWidth: 180,
        valueParser: 'numberParser'
    },
    {
    ...
    {
        field: "in_service",
        headerTooltip: "Specifies if the SVC is in service (True/False)",
        maxWidth: 100
    }
];
...
globalThis.SVCDialog = SVCDialog;
