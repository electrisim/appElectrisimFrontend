...
// Default values for Measurement parameters (based on pandapower documentation)
...
export class MeasurementDialog extends Dialog {
    constructor(editorUi) {
        super('Measurement Parameters', 'Apply');
        ...
        this.loadFlowParameters = [
            {
                ...
                label: 'Name',
                symbol: 'name',
                description: 'Name identifier for the measurement',
                type: 'text',
            ...
            },
            {
                ...
                symbol: 'measurement_type',
                description: 'Type of measurement: v (voltage), i (current), p (power)',
                type: 'text',
                value: this.data.measurement_type
            },
            {
                id: 'element_type',
                label: 'Element Type',
                symbol: 'element_type',
                description: 'Type of element: bus, line, trafo, etc.',
                type: 'text',
            ...
            },
            {
                ...
                label: 'Element Index',
                symbol: 'element',
                description: 'Index of the element being measured',
                type: 'text',
            ...
            },
            {
                ...
                label: 'Side',
                symbol: 'side',
                description: 'For lines/transformers: from or to',
                type: 'text',
...
if (typeof window !== 'undefined') {
    window.MeasurementDialog = MeasurementDialog;
    window.defaultMeasurementData = defaultMeasurementData;
}
