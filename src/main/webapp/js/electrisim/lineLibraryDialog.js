...
// Define the row data for line library
...
/** Offshore 66kV aluminum cables subset for map-to-electrical-model cable sizing */
export const OFFSHORE_66KV_AL_CABLES = rowDefsLineLibrary.filter(
  (r) => r.name && r.name.includes('Offshore 66kV') && r.name.includes('RM Al')
);
...
export const columnDefsLineLibrary = [
    ...
    { field: "r_ohm_per_km", headerName: "R (Ω/km)", headerTooltip: "line resistance in ohm per km", maxWidth: 120, valueParser: numberParser },
    { field: "x_ohm_per_km", headerName: "X (Ω/km)", headerTooltip: "line reactance in ohm per km", maxWidth: 120, valueParser: numberParser },
    { field: "c_nf_per_km", headerName: "C (nF/km)", headerTooltip: "line capacitance (line-to-earth) in nano Farad per km", maxWidth: 120, valueParser: numberParser },
    { field: "g_us_per_km", headerName: "G (μS/km)", headerTooltip: "dielectric conductance in micro Siemens per km", maxWidth: 120, valueParser: numberParser },
    { field: "max_i_ka", headerName: "I_max (kA)", headerTooltip: "maximum thermal current in kilo Ampere", maxWidth: 120, valueParser: numberParser },
    { field: "type", headerName: "Type", headerTooltip: 'type of line ("ol" for overhead line or "cs" for cable system)', maxWidth: 80 },
    { field: "r0_ohm_per_km", headerName: "R0 (Ω/km)", headerTooltip: "zero sequence line resistance in ohm per km", maxWidth: 120, valueParser: numberParser },
    { field: "x0_ohm_per_km", headerName: "X0 (Ω/km)", headerTooltip: "zero sequence line reactance in ohm per km", maxWidth: 120, valueParser: numberParser },
    { field: "c0_nf_per_km", headerName: "C0 (nF/km)", headerTooltip: "zero sequence line capacitance in nano Farad per km", maxWidth: 120, valueParser: numberParser },
    { field: "endtemp_degree", headerName: "End Temp (°C)", headerTooltip: "Short-Circuit end temperature of the line", maxWidth: 140, valueParser: numberParser }
];

// Grid options with improved styling and functionality
export const gridOptionsLineLibrary = {
    suppressClickEdit: false,
    editType: "fullRow",
    rowSelection: "single",
    columnDefs: columnDefsLineLibrary,
    defaultColDef: {
        editable: true,
        sortable: true,
        filter: true,
    ...
    onSelectionChanged: function() {
        ...
        const editBtn = document.getElementById('line-edit-btn');
...
globalThis.columnDefsLineLibrary = columnDefsLineLibrary;
globalThis.gridOptionsLineLibrary = gridOptionsLineLibrary;
