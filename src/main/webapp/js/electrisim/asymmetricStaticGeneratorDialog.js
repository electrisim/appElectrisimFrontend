...
// Default values for asymmetric static generator parameters (based on pandapower documentation)
export const defaultAsymmetricStaticGeneratorData = {
...
export class AsymmetricStaticGeneratorDialog extends Dialog {
    constructor(editorUi) {
        super('Asymmetric Static Generator Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'power';
        this.data = { ...defaultAsymmetricStaticGeneratorData };
        ...
        this.powerParameters = [
            {
                ...
                description: 'Name identifier for the asymmetric static generator',
                type: 'text',
            ...
            },
            {
                ...
                description: 'The active power of the static generator: Phase A (positive for generation!)',
                type: 'number',
            ...
            },
            {
                ...
                description: 'The active power of the static generator: Phase B (positive for generation!)',
                type: 'number',
            ...
            },
            {
                ...
                description: 'The active power of the static generator: Phase C (positive for generation!)',
                type: 'number',
        ...
        this.reactivePowerParameters = [
            {
                ...
                description: 'The reactive power of the static generator: Phase A',
                type: 'number',
            ...
            },
            {
                ...
                description: 'The reactive power of the static generator: Phase B',
                type: 'number',
            ...
            },
            {
                ...
                description: 'The reactive power of the static generator: Phase C',
                type: 'number',
        ...
        this.configParameters = [
            ...
            },
            {
                ...
                description: 'An OPTIONAL scaling factor to be set customly. Multiplies with p_mw and q_mvar of all phases',
                type: 'number',
            ...
            },
            {
                ...
                description: 'Three phase connection type of the static generator: wye/delta',
                type: 'select',
    ...
    getDescription() {
        return '<strong>Configure Asymmetric Static Generator Parameters</strong><br>Set parameters for three-phase asymmetric static generator with individual phase power values. Based on <a href="https://pandapower.readthedocs.io/en/latest/elements/asymmetric_sgen.html" target="_blank">pandapower documentation</a>.';
    }
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('Asymmetric Static Generator values:', values);
    ...
    destroy() {
        ...
        console.log('Asymmetric Static Generator dialog destroyed and flags cleared');
    }
    
    populateDialog(cellData) {
        console.log('=== AsymmetricStaticGeneratorDialog.populateDialog called ===');
        ...
        if (cellData && cellData.attributes) {
            ...
            for (let i = 0; i < cellData.attributes.length; i++) {
                ...
                const reactivePowerParam = this.reactivePowerParameters.find(p => p.id === attributeName);
                if (reactivePowerParam) {
                    const oldValue = reactivePowerParam.value;
                    if (reactivePowerParam.type === 'checkbox') {
                        reactivePowerParam.value = attributeValue === 'true' || attributeValue === true;
                    } else {
                        reactivePowerParam.value = attributeValue;
                    }
                    console.log(`  Updated reactivePower ${attributeName}: ${oldValue} → ${reactivePowerParam.value}`);
                }
                ...
                if (!powerParam && !reactivePowerParam && !configParam) {
        ...
        console.log('=== AsymmetricStaticGeneratorDialog.populateDialog completed ===');
    }
}

// Legacy exports for backward compatibility (maintaining AG-Grid structure for existing code)
export const rowDefsAsymmetricStaticGenerator = [defaultAsymmetricStaticGeneratorData];

export const columnDefsAsymmetricStaticGenerator = [  
    {
        field: "name",
        headerTooltip: "Name of the asymmetric static generator",
        maxWidth: 150
    },
    {
        field: "p_a_mw",
        headerTooltip: "The active power of the static generator: Phase A (positive for generation!)",
        maxWidth: 120,
        valueParser: 'numberParser'
    },
    {
        field: "p_b_mw",
        headerTooltip: "The active power of the static generator: Phase B (positive for generation!)",
        maxWidth: 120,
        valueParser: 'numberParser'
    },
    {
        field: "p_c_mw",
        headerTooltip: "The active power of the static generator: Phase C (positive for generation!)",
        maxWidth: 120,
        valueParser: 'numberParser'
    },
    {
        field: "q_a_mvar",
        headerTooltip: "The reactive power of the static generator: Phase A",
        maxWidth: 140,
        valueParser: 'numberParser'
    },
    {
        field: "q_b_mvar",
        headerTooltip: "The reactive power of the static generator: Phase B",
        maxWidth: 140,
        valueParser: 'numberParser'
    },
    {
        field: "q_c_mvar",
        headerTooltip: "The reactive power of the static generator: Phase C",
        maxWidth: 140,
        valueParser: 'numberParser'
    },
    {
    ...
    {
        field: "scaling",
        headerTooltip: "An OPTIONAL scaling factor to be set customly. Multiplies with p_mw and q_mvar of all phases",
        maxWidth: 140,
        valueParser: 'numberParser'
    },
    {
...
globalThis.AsymmetricStaticGeneratorDialog = AsymmetricStaticGeneratorDialog;
