...
function onCellClicked(params) {
    ...
    if (params.column.colId === "action" && params.event.target.dataset.action) {
      ...
      if (action === "delete") {
        ...
        rowDefsThreeWindingTransformerBase.splice(removeRowIndex, 1); //usun jeden element z indexu
      ...
      if (action === "update") {
        var rowNode = gridOptionsThreeWindingTransformerBase.api.getRowNode(params.node.rowIndex);      
  ...
  function onRowEditingStarted(params) {
    ...
    rowDefsThreeWindingTransformerBase.push(params.node.data) //DODANE PO PORÓWNANIU Z LINEDIALOG
  ...
  function setThreeWindingTransformerCsvData(keys, values) {
    ...
    rowDefsThreeWindingTransformerBase.push(result)
  
  
    gridOptionsThreeWindingTransformerBase.api.setRowData(rowDefsThreeWindingTransformerBase);
  ...
  var gridOptionsThreeWindingTransformerBase = {
    ...
    onSelectionChanged: () => {
      const selectedData = gridOptionsThreeWindingTransformerBase.api.getSelectedRows();
