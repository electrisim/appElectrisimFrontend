...
/**
 * Fully rated converter WTG 2.5 MW 50 Hz Q(P,U) tables (p.u. of Sn).
 * Matches PowerFactory type "Fully Rated Converter WTG 2.5MW 50Hz" (Qmax/Qmin matrices).
 * Rows = U [pu], columns = P [pu]. Q = 0 at P = 0.
 */
