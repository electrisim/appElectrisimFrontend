...
// Default values for Source DC parameters (based on pandapower documentation)
export const defaultSourceDcData = {
    name: "Source DC",
    vm_pu: 1.0,
    in_service: true
};

export class SourceDcDialog extends Dialog {
    constructor(editorUi) {
        super('Source DC Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'loadflow';
        this.data = { ...defaultSourceDcData };
        this.inputs = new Map();
        ...
        this.loadFlowParameters = [
            {
                ...
                label: 'Name',
                symbol: 'name',
                description: 'Name identifier for the DC source',
                type: 'text',
            ...
            },
            {
                ...
                symbol: 'vm_pu',
                unit: 'p.u.',
                description: 'The voltage set point of the DC source (>0)',
                type: 'number',
            ...
            },
            {
                ...
                label: 'In Service',
                symbol: 'in_service',
                description: 'Specifies if the DC source is in service (True/False)',
                type: 'checkbox',
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('Source DC values:', values);
...
if (typeof window !== 'undefined') {
    window.SourceDcDialog = SourceDcDialog;
    window.defaultSourceDcData = defaultSourceDcData;
}
