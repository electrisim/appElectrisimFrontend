 rowDefsDataTransformerDialog = [
  ...
  const columnDefsTransformerDialog = [
      ...
      { field: "vkr_percent",
      headerTooltip: "real part of relative short-circuit voltage",
      maxWidth: 120,
      valueParser: numberParser,
      },
      { field: "vk_percent",
      headerTooltip: "relative short-circuit voltage",
      maxWidth: 120,
      valueParser: numberParser,
      },
      { field: "pfe_kw",
      ...
      { field: "i0_percent",
      headerTooltip: "open loop losses in percent of rated current",
      maxWidth: 100,
      valueParser: numberParser,
      },
      { field: "shift_degree",
      ...
      { field: "vk0_percent",
      headerTooltip: "zero sequence relative short-circuit voltage",
      maxWidth: 120,
      valueParser: numberParser,
      },
      { field: "vkr0_percent",
      headerTooltip: "real part of zero sequence relative short-circuit voltage",
      maxWidth: 120,
      valueParser: numberParser,
      },
      { field: "mag0_percent",
      headerTooltip: "zero sequence magnetizing impedance/ vk0",
      maxWidth: 120,
      valueParser: numberParser,
      },
      ...
      { field: "tap_min", headerTooltip: "minimal allowed tap position",
       maxWidth: 100 //tutaj może być liczba ujemna dlatego nie używam numberParser     
      },
      { field: "tap_step_percent",
      headerTooltip: "tap step size for voltage magnitude in percent",
      maxWidth: 140,
      valueParser: numberParser,
      },
