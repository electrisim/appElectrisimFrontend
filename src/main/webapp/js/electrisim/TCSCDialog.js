...
export class TCSCDialog extends Dialog {
    ...
    getDescription() {
        return '<strong>Configure TCSC Parameters</strong><br>Set parameters for Thyristor-Controlled Series Capacitor with thyristor-controlled series compensation. See the <a href="https://electrisim.com/documentation.html#tcsc" target="_blank" rel="noopener noreferrer">Electrisim documentation</a>.';
    }
