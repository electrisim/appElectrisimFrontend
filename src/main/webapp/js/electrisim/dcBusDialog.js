...
export class DcBusDialog extends Dialog {
    constructor(editorUi) {
        super('DC Bus Parameters', 'Apply');
        
        this.ui = editorUi || window.App?.main?.editor?.editorUi;
        this.graph = this.ui?.editor?.graph;
        this.currentTab = 'loadflow';
        this.data = { ...defaultDcBusData };
        this.inputs = new Map();
        ...
        this.loadFlowParameters = [
            {
                ...
                label: 'Name',
                symbol: 'name',
                description: 'Name identifier for the DC bus',
                type: 'text',
            ...
            },
            {
                ...
                symbol: 'vn_kv',
                unit: 'kV',
                description: 'The grid voltage level at this DC bus (>0)',
                type: 'number',
            ...
            },
            {
                ...
                label: 'In Service',
                symbol: 'in_service',
                description: 'Specifies if the DC bus is in service (True/False)',
                type: 'checkbox',
                value: this.data.in_service
            }
        ];
        
        // Short Circuit parameters (DC buses don't have specific SC parameters)
    ...
    showTabDialog() {
        ...
        applyButton.onclick = (e) => {
            ...
            console.log('DC Bus values:', values);
...
if (typeof window !== 'undefined') {
    window.DcBusDialog = DcBusDialog;
    window.defaultDcBusData = defaultDcBusData;
}
