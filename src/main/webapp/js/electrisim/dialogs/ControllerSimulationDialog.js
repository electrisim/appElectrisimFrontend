...
(function() {
    class ControllerSimulationDialog {
        ...
        show(callback) {
            ...
            blurb.innerHTML = 'Simulate control actions (tap, shunt, and related controls) together with the power flow. See the <a href="https://electrisim.com/documentation.html#controller-simulation" target="_blank" rel="noopener noreferrer">Electrisim documentation</a>.';
