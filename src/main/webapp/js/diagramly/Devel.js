...
//ELXXX mxscript(drawDevUrl + 'js/diagramly/DriveClient.js');
//ELXXXmxscript(drawDevUrl + 'js/diagramly/DropboxFile.js');
 //ELXXX mxscript(drawDevUrl + 'js/diagramly/DropboxLibrary.js');
//ELXXX mxscript(drawDevUrl + 'js/diagramly/DropboxClient.js');
...
//ELXXX mxscript(drawDevUrl + 'js/diagramly/OneDriveFile.js');
//ELXXX mxscript(drawDevUrl + 'js/diagramly/OneDriveLibrary.js');
//ELXXX mxscript(drawDevUrl + 'js/diagramly/OneDriveClient.js');
